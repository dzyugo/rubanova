...
const dict = {
  ...
  "home.featured.sub": { en: "Hand-picked by our team — updated weekly.", ar: "مختارات فريقنا — تتحدث أسبوعياً." },
  ...
  "home.newsletter.sub": { en: "Get seasonal recipes, wellness tips, and exclusive early access to our limited harvests delivered to your inbox.", ar: "احصل على وصفات موسمية، نصائح صحية، وصول مبكر حصري لمحاصيلنا المحدودة مباشرة إلى بريدك." },
  ...
  "shop.subtitle": { en: "Selected fresh produce and essentials for your vitality.", ar: "منتجات طازجة مختارة لحيويتك." },
  ...
  "product.related.sub": { en: "Complete your basket with these fresh additions.", ar: "أكمل سلتك بهذه الإضافات الطازجة." },
  ...
  "cart.subtitle": { en: "Review your curated selection before checkout.", ar: "راجع اختياراتك قبل الدفع." },
  "cart.empty": { en: "Your basket is empty", ar: "سلتك فارغة" },
  "cart.empty.sub": { en: "Explore our fresh harvest and add items to get started.", ar: "استكشف محصولنا الطازج وأضف منتجات للبدء." },
  ...
  "checkout.empty.sub": { en: "Add some fresh produce to your basket first.", ar: "أضف بعض المنتجات الطازجة إلى سلتك أولاً." },
  ...
  "auth.login.sub": { en: "Sign in to view orders and manage addresses.", ar: "سجل دخولك لعرض الطلبات وإدارة العناوين." },
  "auth.signup.sub": { en: "Join Ruba Nova for faster checkout and saved orders.", ar: "انضم إلى روبا نوفا لدفع أسرع وطلبات محفوظة." },
  ...
  "auth.noorders": { en: "No orders yet. Time to fill your basket.", ar: "لا توجد طلبات بعد. حان وقت ملء سلتك." },
  ...
  "about.p1": { en: "Ruba Nova began as a weekend stall at the Portland Farmers Market — three crates of heirloom tomatoes, a hand-painted sign, and an unshakable belief that food should nourish both people and the planet.", ar: "بدأت روبا نوفا كمحل صغير في سوق المزارعين — ثلاث صناديق من الطماطم الموروثة، لافتة مرسومة يدوياً، وإيمان راسخ بأن الغذاء يجب أن يغذي الناس والكوكب معاً." },
  "about.p2": { en: "Today we partner with over 40 regenerative farms across the Pacific Northwest to bring you seasonal produce that is never sprayed, never waxed, and always picked at peak ripeness.", ar: "اليوم نتعاون مع أكثر من 40 مزرعة مستدامة لنقدم لك منتجات موسمية لم تُرش أبداً، ولم تُشمّع أبداً، وتُقطف دائماً في ذروة نضجها." },
  "about.p3": { en: "Every box we ship is plastic-free, every delivery route is carbon-offset, and every penny of profit beyond operating costs goes back into soil health initiatives. That's the Ruba Nova promise.", ar: "كل صندوق نشحنه خالٍ من البلاستيك، كل مسار توصيل يعوّض الكربون، وكل فلس ربح يعود إلى مبادرات صحة التربة. هذا وعد روبا نوفا." },
  "about.cta": { en: "Explore our harvest →", ar: "← استكشف محصولنا" },

  // Contact
  "contact.title": { en: "Get in Touch", ar: "تواصل معنا" },
  "contact.subtitle": { en: "Whether you have a question, wholesale inquiry, or just want to say hello — we'd love to hear from you.", ar: "سواء كان لديك سؤال، استفسار عن الجملة، أو مجرد تحية — يسعدنا سماعك." },
  ...
  "notfound.sub": { en: "The page you're looking for doesn't exist or has been moved.", ar: "الصفحة التي تبحث عنها غير موجودة أو تم نقلها." },
