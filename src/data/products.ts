...
export const fallbackProducts: Product[] = [
  {
    ...
    nutrition: { servingSize: "100g", calories: "49 kcal", vitaminK: "681% DV", vitaminC: "134% DV", fiber: "4.1g" },
    is_featured: true,
    stock: 24,
  },
  {
  ...
  },
  {
    ...
    description:
      "Purple, orange and golden heirloom carrots with feathery tops. Sweet and earthy.",
    price: 5.3,
    unit: "bunch (~500g)",
