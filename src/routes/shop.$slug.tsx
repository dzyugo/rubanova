    ...
    <section className="mx-auto w-full max-w-7xl px-6 py-12">
      ...
      <div className="mt-8 grid gap-12 lg:grid-cols-2 lg:items-start">
        ...
        <div>
          ...
          <div className="mt-6 flex items-baseline gap-3">
            <span className="font-display text-4xl font-bold text-primary">${product.price.toFixed(2)}</span>
            <span className="text-sm text-muted-foreground">/ {product.unit}</span>
          </div>

          <p className="mt-8 text-xs font-semibold uppercase tracking-widest text-muted-foreground">Select Quantity</p>
          ...
          <div className="mt-8 rounded-2xl border border-border bg-card">
            ...
            >
              <span className="flex items-center gap-2 font-display text-base font-bold">
                <Leaf className="size-4 text-primary" /> Nutrition Facts
              </span>
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            {[
              ...
              { icon: Truck, label: "Farm Fresh" },
              { icon: Droplet, label: "Pre-Washed" },
            ].map((b) => (
      ...
      <section className="mt-20">
        <div className="flex items-end justify-between">
          <div>
            <h2 className="font-display text-3xl font-bold">Picks for your Wellness</h2>
            <p className="mt-1 text-muted-foreground">Complete your basket with these fresh additions.</p>
          </div>
